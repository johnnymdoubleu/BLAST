...
fwi.scaled <- as.data.frame(pca.res$x)
...
plot(pca.res$x[,3], log(y))
plot(fwi.index[which(Y>u),3], log(y))
plot(pca.res$x[,4], log(y))
plot(pca.res$x[,5], log(y))
