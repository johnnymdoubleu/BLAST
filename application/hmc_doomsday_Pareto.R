...
data.stan <- list(y = as.vector(y), u = u, p = p, n= n, psi = psi, 
                    ...
                    xholderLinear = xholder.linear, xholderNonlinear = xholder.nonlinear, basisFL = basis.holder, supermax = supermax.x,
                    supermaxbs = super.holder,
