...
vgam.vcov.scale <- vcov(vgam.fit.scale)
vgam.hess.scale <- solve(vgam.vcov.scale)
vgam.se.scale <- sum(diag(vgam.vcov.scale))
vgam.det.scale <- det(vgam.hess.scale)
vgam.kappa.scale <- kappa(vgam.hess.scale)
