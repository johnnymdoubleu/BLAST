...
for(iter in 1:total.iter){
  ...
  g4 <- g4.l + g4.nl
  g3 <- g3.l + g3.nl
  eta.g <- rep(theta.adjusted[1], newx.length) + g4 + g3 + g1.l
...
# ggsave(paste0("./simulation/results/",Sys.Date(),"_",total.iter,"_MC_smooth_scD2_",n.origin,".pdf"), width=12.5, height = 15)
